  ...
  return (
    <div className="max-w-[1160px] mx-auto pb-[120px]">
      ...
      <div className="p-[clamp(16px,3vw,28px)] pt-[clamp(16px,3vw,26px)]">
        {screen === 'dashboard' && <Dashboard screen={screen} transactions={transactions} technicians={technicians} services={services} showToast={showToast} refreshData={fetchData} />}
        ...
        {screen === 'teknisi' && <Teknisi screen={screen} technicians={technicians} settings={settings} />}
        {screen === 'pendapatan' && <Pendapatan screen={screen} transactions={transactions} settings={settings} />}
        {screen === 'pelanggan' && <Pelanggan screen={screen} customers={customers} settings={settings} showToast={showToast} refreshData={fetchData} />}
